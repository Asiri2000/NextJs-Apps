...
import { FaFacebook, FaI, FaInstagram, FaTiktok, FaTwitter, FaX } from "react-icons/fa6";
    ...
    <div className="mt-8 w-[80%] mx-auto border-t pt-8 flex flex-col md:flex-row justify-between
     items-center text-gray-600 text-sm">
      ...
      <p className="text-center md:text-left">
         Copyright © 2026 Visio Innovation. All rights reserved.
         </p>
